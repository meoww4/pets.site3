    ...
    <div className="col-md-4">
      <div className="card">
        ...
        <div className="button-container">
          <button className="btn btn-primary" onclick="alert('Редактировать объявление')">Редактировать</button>
          <button className="btn btn-danger" onclick="alert('Объявление удалено')">Удалить</button>
        </div>
      </div>
    </div>
    <div className="col-md-4">
